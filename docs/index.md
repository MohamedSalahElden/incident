...
-   ![alt text](image-5.png)
    ...
    **2.1M+ Records**{.cve-chip}
    ...
    [:octicons-arrow-right-24: View Full Details](everest-att-aviation-leaks.md)
...
-   ![alt text](image-6.png)
    ...
    **Disputed Incident**{.cve-chip}
    ...
    [:octicons-arrow-right-24: View Full Details](hsbc-usa-data-breach.md)
...
-   ![alt text](image-7.png)
    ...
    **Healthcare systems**{.cve-chip}
    ...
    [:octicons-arrow-right-24: View Full Details](vertikal-hospital-manager.md)
